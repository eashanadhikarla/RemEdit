...
#     def __init__(
#         self, *, in_channels, out_channels=None, conv_shortcut=False, dropout, temb_channels=512, layer_type="conv",
#         nheads=1, num_layers=1, dim_feedforward=2048, emb_type="add", use_midblock=False
#     ):
#         super().__init__()
...
#         use_clip=False,          # New addition
#         use_contrastive=False    # New addition
#     ):
#         super().__init__()
#         self.use_midblock = use_midblock
#         self.emb_type = emb_type
#         self.layer_type = layer_type
#         self.use_clip = use_clip                # New addition
#         self.use_contrastive = use_contrastive  # New addition
...
#         # Riemannian manifold block to generate delta_h
...
#             delta_h = delta_h + contrastive_loss  # Incorporate contrastive loss

#         # CLIP embedding modulation (if enabled)
#         if self.use_clip and clip_embedding is not None:
#             clip_modulation = self.clip_proj(clip_embedding)
#             delta_h = delta_h + clip_modulation
...
# ######################################
# Enhanced-RiemannianBlock in DeltaBlock
# ######################################
...
class DeltaBlock(nn.Module):
    def __init__(self, *, in_channels, out_channels=None, conv_shortcut=False, dropout, temb_channels=512,
        layer_type="conv", nheads=1, num_layers=1, dim_feedforward=2048, emb_type="add", use_midblock=False,
        use_clip=False, use_contrastive=False, geodesic_scale=2.0, adaptive_scaling=True):
        super().__init__()
        self.use_midblock = use_midblock
        self.emb_type = emb_type
        self.layer_type = layer_type
