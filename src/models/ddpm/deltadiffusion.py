    ...
    def forward(self, x, t, index=None, t_edit=400, hs_coeff=(1.0, 1.0), delta_h=None, ignore_timestep=False, use_mask=False, clip_direction=None):
        ...
        if index is not None:
            ...
            if t[0] >= t_edit:
                ...
                # use input delta_h  : even tough you do not use DeltaBlock, you need to use index is 0.
                else:  # DiffStyle; Just ignore this code.
                    if use_mask:
...
#         # # ExponentialMap for accurate geodesic computation with full-ODE solver
#         self.exp_map = ExponentialMapTrue(out_channels, temb_channels)#, text_dim=512) #, clip_model=clip_encoder
