...
python main.py  --run_test                              \
                --config $config                        \
                --exp ./runs/exp13b_1000_smile/${guid}      \
                --edit_attr $guid                       \
                --do_train 0                            \
                --do_test 1                             \
                --n_train_img 5                         \
                ...
                --save_process_origin                   \
                --save_x_origin                         \
                --manual_checkpoint_name "/home/ubuntu/controlbfr/RiemannianEdit/src/checkpoint/smiling_LC_CelebA_HQ_t999_ninv50_ngen50_4.pth" \
                --use_cssa_early_exit \
