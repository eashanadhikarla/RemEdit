...
config="celeba.yml"
guid="smiling"
test_step=10    # if large, it takes long time.
...
python main.py  --run_test                              \
                ...
                --save_process_origin                   \
                --save_x_origin                         \
                --manual_checkpoint_name "/home/ubuntu/controlbfr/RiemannianEdit/src/checkpoint/smiling_LC_CelebA_HQ_t999_ninv50_ngen50_9.pth"
