...
def parse_args_and_config():
    ...
    # Logging
    parser.add_argument('--sh_file_name', type=str, default='script_train.sh', help='copy the script this file')
    ...
    parser.add_argument('--save_train_image_step', type=int, default=4, help='Whether to save training results during CLIP fineuning')
    parser.add_argument('--save_train_image_iter', type=int, default=1, help='Whether to save training results during CLIP fineuning')
